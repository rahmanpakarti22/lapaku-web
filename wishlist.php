...
<section class="wishlist">
   ...
   <h1 class="title">WISHLIST KAMU</h1>
   ...
   <form action="" method="POST" class="box">
      <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('Hapus Item Ini wishlist?');"></a>
   ...
   <?php
      ...
      echo '<p class="empty">Daftar wishlistmu kosong!</p>';
   }
   ?>
   </div>
